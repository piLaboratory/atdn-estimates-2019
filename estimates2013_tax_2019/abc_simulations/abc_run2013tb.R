...
LN.sims <- mclapply(simulated.vals, f1, sad = "lnorm", sdlog = atdn.13.tax$pln.cf[2], lower=1e-20, upper=1e20, mc.cores=10)
##save.image()
...
save(all.sims, sim.ids, sim.y, file="ABC2013tb.RData")
